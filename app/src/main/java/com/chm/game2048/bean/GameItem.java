...
public class GameItem extends FrameLayout {
    ...
    private void initCardItem() {
        setBackground(getResources().getDrawable(R.drawable.back2));
        // 设置面板背景色，是由Frame拼起来的
        //setBackgroundColor(Color.GRAY);
        mTvNum = new TextView(getContext());
        setNum(mCardShowNum);
        // 修改5X5时字体太大
        int gameLines = Config.mSp.getInt(Config.KEY_GAME_LINES, 5);
        if (gameLines == 4) {
        ...
        mParams.setMargins(5, 5, 5, 5);//添加图形边框
